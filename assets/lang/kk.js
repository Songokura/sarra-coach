...
"a.home":"Сарра Жума, басты бетке","a.role":"гипно-коуч","a.nav":"Сайт бөлімдері","a.lang":"Сайт тілі","a.zay":"Өтінім қалдыру","a.menu":"Мәзір",
...
"b.zay":"Өтінім қалдыру","b.test":"3 минуттық тест өту","b.diag":"Диагностикаға жазылу","b.seat":"Орын алу",
"fh.h":"Диагностикаға жазылу","fh.s":"90 минут, 9 900 ₸. Жауап беріп, уақыт таңдаймын.",
...
"nav.otz":"Пікірлер",
"s.np.k":"Бағыттар","s.np.h":"Диагностикаға немен келеді",
"np.1.h":"Бизнес-коуч","np.1.p":"Бизнес табысы бір орында, шешімдер кейінге қалады, бағаны көтеру қорқынышты.",
"np.2.h":"Қаржылық төбе","np.2.p":"Қанша жұмыс істесеңіз де, табыс жылдар бойы бір деңгейде.",
"np.3.h":"Импостор синдромы","np.3.p":"Жетістік бар, ал ішіңізде - «мен жетпеймін» және әшкереленемін деген қорқыныш.",
"np.4.h":"Гипнотерапия","np.4.p":"Сахнасыз және фокуссыз жұмсақ транс: нанымдармен, қорқыныштармен және өзін-өзі саботаждаумен жұмыс.",
...
"k.tel":"Байланыс телефоны","k.fmt":"Формат","k.fmt.v":"Алматы мен Астанада офлайн, онлайн - бүкіл әлем",
"k.note":"Жазылу тек форма арқылы: сонда өтінім жоғалмайды және мен әркімге жауап беремін.",
"f.name":"Атыңыз","f.phone":"Телефон","f.msg":"Нені өзгерткіңіз келеді?","f.send":"Өтінім жіберу","f.cons":"Форманы жіберу арқылы сіз дербес деректерді өңдеуге келісім бересіз.",
...
ui:{testlab:"«Ақша детекторы» тесті", start:"Тестті бастау", startP:"Шын жауап беріңіз: дұрыс жауап жоқ, сіздің жауабыңыз бар. Нәтиже бірден шығады, пошта мен тіркеусіз.", tags:["15 сұрақ","3 минут","4 деңгей"], q:"Сұрақ", of:"/", back:"Артқа", score:"Сіздің ұпайыңыз", of60:"60-тан", again:"Қайта өту", pot:"Өсу әлеуеті", lv:["Терең бағдарламалар","Елеулі блоктар","Бірнеше блок","Ағын ашық"]},
